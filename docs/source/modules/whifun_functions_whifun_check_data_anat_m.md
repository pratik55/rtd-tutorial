...
#### `no_anat` — MATLAB value inferred from source usage
Output produced by the MATLAB implementation.
...
- **Internal Calls:** `whifun_check_anat_file`, `whifun_get_anat_info`
...
### See Also
- Related internal calls: `whifun_check_anat_file`, `whifun_get_anat_info`
