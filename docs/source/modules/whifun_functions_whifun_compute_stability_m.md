...
### Input Arguments
#### `net_list` — MATLAB value inferred from source usage
Inferred from the signature, variable name, and source usage; precise validation occurs at MATLAB runtime.

#### `net_include` — MATLAB value inferred from source usage
Inferred from the signature, variable name, and source usage; precise validation occurs at MATLAB runtime.
...
### Output Arguments
#### `avg_max_dice` — MATLAB value inferred from source usage
Output produced by the MATLAB implementation.

#### `diceij_all` — MATLAB value inferred from source usage
Output produced by the MATLAB implementation.

#### `vox_num_all` — numeric scalar or numeric vector
Output produced by the MATLAB implementation.
