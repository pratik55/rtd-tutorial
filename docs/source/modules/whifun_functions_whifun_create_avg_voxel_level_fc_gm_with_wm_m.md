...
### Syntax
```matlab
function [avg_vox_level_FC,gm_group_mask_voxels] = whifun_create_avg_voxel_level_fc_GM_with_WM(cluster_folder,Subj_list,wm_group_mask_path,gm_group_mask_path,sub_sample_choose,over_write,d_flag,d,steps_,tot_steps)
```
