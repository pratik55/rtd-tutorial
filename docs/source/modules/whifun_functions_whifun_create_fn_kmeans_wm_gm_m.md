...
#### `group_mask_path_wm` — character vector or string scalar filesystem path
Inferred from the signature, variable name, and source usage; precise validation occurs at MATLAB runtime.

#### `group_mask_path_gm` — character vector or string scalar filesystem path
Inferred from the signature, variable name, and source usage; precise validation occurs at MATLAB runtime.
...
- **Internal Calls:** `load_subjects`, `whifun_build_net`, `whifun_create_avg_ts`, `whifun_create_avg_voxel_level_fc_GM_with_noise`, `whifun_create_avg_voxel_level_fc_GM_with_WM`, `whifun_create_avg_voxel_level_fc_noise_with_GM`, `whifun_create_avg_voxel_level_fc_WM_with_GM`, `whifun_create_brainnet_images`, `whifun_get_best_k`, `whifun_get_FN_kmeans`
...
### See Also
- Related internal calls: `load_subjects`, `whifun_build_net`, `whifun_create_avg_ts`, `whifun_create_avg_voxel_level_fc_GM_with_noise`, `whifun_create_avg_voxel_level_fc_GM_with_WM`, `whifun_create_avg_voxel_level_fc_noise_with_GM`, `whifun_create_avg_voxel_level_fc_WM_with_GM`, `whifun_create_brainnet_images`, `whifun_get_best_k`, `whifun_get_FN_kmeans`
- Related callers: `main.mlapp:2486/CreateWMGMFNButtonPushed`
