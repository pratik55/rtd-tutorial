...
#### `matlab_cor` — numeric scalar, vector, matrix, or multidimensional array
Output produced by the MATLAB implementation.
...
- **Internal Calls:** `niftisave`, `whifun_convert_coords`, `whifun_create_sphere`, `whifun_extract_ts_from_vox`, `whifun_niftiread`
...
### See Also
- Related internal calls: `niftisave`, `whifun_convert_coords`, `whifun_create_sphere`, `whifun_extract_ts_from_vox`, `whifun_niftiread`
