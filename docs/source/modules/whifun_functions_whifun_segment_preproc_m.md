...
#### `out_def_path` — character vector or string scalar filesystem path
Output produced by the MATLAB implementation.
...
- **Internal Calls:** `whifun_create_file`, `whifun_multiple_file_found`, `whifun_segment`, `write_error`
...
### See Also
- Related internal calls: `whifun_create_file`, `whifun_multiple_file_found`, `whifun_segment`, `write_error`
