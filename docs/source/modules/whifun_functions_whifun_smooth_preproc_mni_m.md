...
- **Internal Calls:** `whifun_create_file`, `whifun_smooth_together`, `write_error`
...
### See Also
- Related internal calls: `whifun_create_file`, `whifun_smooth_together`, `write_error`
- Related callers: `whifun_functions/whifun_post_proc_hcp_dev.m:1/whifun_post_proc_hcp_dev`
