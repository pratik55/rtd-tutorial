...
#### `OutName` — character vector, string scalar, or categorical option
Inferred from the signature, variable name, and source usage; precise validation occurs at MATLAB runtime.
...
### See Also
- Related callers: `whifun_functions/reslice_data.m:1/reslice_data`, `whifun_functions/save_mat_to_nifti.m:1/save_mat_to_nifti`
